...
import se.fk.github.bekraftabeslut.WireMockBekraftaBeslut;
...
public class BekraftaBeslutOulTest extends RegelManuellTestBase
{
   ...
   void should_send_oul_request_message(String handlaggningId)
   {
      ...
      assertTrue(oulRequestMessage.getUrl().contains("/regel/bekraftabeslut"));
   }
